...
public class JavaIntroEj07 {
    public static void main(String[] args) {
        ...
        System.out.println("1: Motor de agua");
        System.out.println("2: Motor de gasolina");
        System.out.println("3: Motor de hormigon");
        System.out.println("4: Motor de pasta alimenticia");
        ...
        switch (motor) {
            ...
            case 3: 
                ...
                break;
            case 4:
                System.out.println("La bomba es una bomba de alimenticio");   
                break;
            default:
